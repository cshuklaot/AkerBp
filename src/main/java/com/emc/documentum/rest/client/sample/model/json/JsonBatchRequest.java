...
import com.emc.documentum.rest.client.batch.Header;
...
public class JsonBatchRequest implements SettableRequest {
	...
	public boolean equals(Object obj) {
		...
		return Equals.equal(uri, that.uri) && Equals.equal(method, that.method)
				&& Equals.equal(attachment, that.attachment) && Equals.equal(attachments, that.attachments)
				&& Equals.equal(batchHeaders, that.batchHeaders) && Equals.equal(entity, that.entity);
	}
