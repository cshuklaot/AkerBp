...
public class JsonBatchResponse implements com.emc.documentum.rest.client.batch.Response {
	private int status;
	...
	public boolean equals(Object obj) {
		...
		return Equals.equal(status, that.status) && Equals.equal(headers, that.headers)
