...
public abstract class AbstractSetAttribute implements SetSysobjectAttribute {
	...
	@Override
	public void set(final IDfSysObject object, final String attrName, final int attrIndex, final Node valueNode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	protected abstract void setValue(IDfSysObject object, String attrName, int attrIndex, Node valueNode)
			throws Exception;
	 ...
	 * @param valueNode
	 *            node to check.
	 * @return <code>true</code> if there is at least one child processing
	 *         instruction node. Recursively traverse all children node.
	 */
